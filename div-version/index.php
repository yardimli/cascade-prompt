...
<head>
	...
	<script src="js/grid-select.js"></script>
	...
	<script>
		...
		$(document).ready(function () {
			...
			const gridSelector = new GridSelector(grid);
			...
			grid.setCellValue(4, 'B', '1',false);
			grid.setCellValue(4, 'C', '2',false);
			grid.setCellValue(5, 'B', '3',false);
			grid.setCellValue(5, 'C', '4',false);
